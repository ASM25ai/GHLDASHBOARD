...
// Returns: {
//   dealerName, 
//   allTime:   { total, byFM, refundsByFM, totalRefunds },
//   thisMonth: { total, byFM, refundsByFM, totalRefunds, byDay }
// }

async function aggregateDealerStats(config) {
  const { name, locationId, apiKey, deliveredTag = 'qualified', fmTagMap = {} } = config;
